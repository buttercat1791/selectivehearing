...
var Parser = require('./jsontocsv.js');
...
class HashtagSearch {
    ...
    async getJsonArray(hashtag) {
        ...
        this.twitterClient.get(this.searchApiEndpoint, {q: hashtag,
            ...
            this.getMoreResults(hashtag, maxID, countCollected, parser);
        });
    }
    ...
    getMoreResults(hashtag, maxID, countCollected, parser) {
